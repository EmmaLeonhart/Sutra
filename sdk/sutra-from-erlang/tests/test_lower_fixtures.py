...
_RUNNABLE = {
    ...
    "multiarg_nontail_multibase": 115.0,  # f(0,B)->B; f(1,B)->B+100; f(A,B)->A+f(A-1,B); f(3,10)=3+2+(10+100)=115  (MULTI-ARG non-tail multibase fold: loop carries (A,B,_acc), folds _acc+A each step, base blend keyed on final (A,B); _foldable_step_multi)

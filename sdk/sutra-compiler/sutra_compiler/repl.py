...
_HELP = (
    ...
    "  do_while f(...) { } add a loop function (also while_loop / iterative_loop /\n"
    "                      foreach_loop); then call it in any form:\n"
    "                        loop f(cond, expr)           evaluate to the final state\n"
    "                        (a, b) = loop g(cond, ...);  bind a multi-state result\n"

...
class Codegen(BaseCodegen):
    ...
    def _emit_prelude(self) -> None:
        ...
        self._emit("# axes (0..AXIS_CHAR_FLAG) for int/complex/truth/char representation.")
        ...
        self._emit('')
        self._emit("Returns a Python float — the value on the real leg of the slot\'s")
        self._emit("plane. Other slots and semantic content do not contribute; the")
        self._emit("disjoint-plane allocation makes this a projection, not a noisy")
        self._emit("readout.")
        self._emit('"""')

...
# REMOVED 2026-06-07: "ram_tensor_step" / "fused_ram_machine" demos +
# test_runtime_functional_ram_ops. They embodied a wrong architecture (RAM as a
# fused VRAM tensor). The NTM keeps RAM EXTERNAL (orchestrator + VRAM mailbox;
# planning/sutra-spec/ram-pointers.md). Loop/RNN fusion (the remaining demos)
# stays correct.

...
The compiler for the [Sutra programming language](https://sutra.topazcomputing.com) — a purely functional language whose primitives are tensor operations on frozen-LLM embedding vectors.
...
For a full introduction, see [sutra.topazcomputing.com](https://sutra.topazcomputing.com). For the language specification and design rationale, see the [Sutra repository](https://github.com/EmmaLeonhart/Sutra).

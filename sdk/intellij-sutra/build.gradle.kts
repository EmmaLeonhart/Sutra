/*
 * Sutra IntelliJ Platform plugin — v0.1 scaffold.
 *
...
dependencies {
    // Gson is used by SutraExternalAnnotator to parse the `--json` output
...
tasks {
    ...
    buildSearchableOptions {
        ...
        // every Configurable; it's slow but gives us "Sutra" hits in the
        // Settings search box now that SutraSettingsConfigurable exists.
    ...
    test {
        ...
        // SutraLexer driven directly from unit tests.
        useJUnit()
    }
}

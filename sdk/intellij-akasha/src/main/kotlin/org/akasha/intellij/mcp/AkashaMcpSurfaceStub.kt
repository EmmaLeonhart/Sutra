...
/**
 * Stub implementation of [AkashaMcpSurface]. Every method throws
 ...
 * revision in `sdk/intellij-akasha/README.md`.
 */
class AkashaMcpSurfaceStub : AkashaMcpSurface {
    ...
    override fun diagnostics(filePath: String): Any =
        unimplemented("diagnostics", "reachable via AkashaExternalAnnotator; needs MCP adapter")
    ...
    private fun unimplemented(name: String, blocker: String): Nothing =
        throw NotImplementedError(
            "AkashaMcpSurface.$name is design-only. Blocker: $blocker. " +
                    "See planning/akasha-spec/20-ide-architecture.md §\"Minimum Agent Workflows\"."
        )
}

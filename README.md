...
| [`docs/`](docs/) | Hand-written Markdown source for the website at <https://sutra.topazcomputing.com> — the homepage plus concept guides (capabilities, compilation, loops, operators, vision, …), tutorials, and the NeurIPS archive page. One HTML page per file. |

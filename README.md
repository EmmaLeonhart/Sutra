...
**Website · [sutra.noldor.tech](https://sutra.noldor.tech)**
...
| [`docs/`](docs/) | Hand-written Markdown source for the website at <https://sutra.noldor.tech> — the homepage plus concept guides (capabilities, compilation, loops, operators, vision, …), tutorials, and the NeurIPS archive page. One HTML page per file. |

...
| File | Link |
|------|------|
| Paper source markdown | [`paper/neurips/paper.md`](https://github.com/EmmaLeonhart/Sutra/blob/main/paper/neurips/paper.md) |
| LaTeX wrapper | [`paper/neurips/paper.tex`](https://github.com/EmmaLeonhart/Sutra/blob/main/paper/neurips/paper.tex) |
| NeurIPS style file | [`paper/neurips/neurips_2026.sty`](https://github.com/EmmaLeonhart/Sutra/blob/main/paper/neurips/neurips_2026.sty) |
| Supplementary docs | [`paper/neurips/supplementary/`](https://github.com/EmmaLeonhart/Sutra/tree/main/paper/neurips/supplementary) |
| In-repo README | [`paper/neurips/README.md`](https://github.com/EmmaLeonhart/Sutra/blob/main/paper/neurips/README.md) |
...
under [`paper/reviews/`](https://github.com/EmmaLeonhart/Sutra/tree/main/paper/reviews)

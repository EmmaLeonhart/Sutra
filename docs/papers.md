...
5. **Compile-to-brain as the far-edge stress test.** §6.6 reports that an earlier version of the compiler targeted a Brian2 spiking simulation of the *Drosophila melanogaster* mushroom body, with **16/16 correct decisions** across four program variants × four input conditions. Full reproduction was documented in the second paper, below — that research line was retired 2026-04-26 (see the note on paper 2).

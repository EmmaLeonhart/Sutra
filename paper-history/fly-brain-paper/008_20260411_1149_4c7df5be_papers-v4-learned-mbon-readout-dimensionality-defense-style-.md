<!--
commit:  4c7df5bea3ca4b129415872dabc3b969c82acac4
date:    2026-04-11 11:49:20 -0700
subject: papers v4: learned MBON readout, dimensionality defense, style cleanup, paper fixes
...
- `test_codegen_e2e.py` — end-to-end reproduction of the main result: parses the reference `.ak` source, runs the codegen backend, and executes the generated Python against the Brian2 mushroom body simulation.

...
1. **🔴 META-BLOCKER: Fly-brain Python-file sprawl cleanup.**
   ...
   containers. Claude Code running on Immanuelle's desktop has Brian2
   and the FlyWire cache at `C:\Users\Immanuelle\flybrain\` and **can**
   do this cleanup.)

...
with open(os.path.join(script_dir, 'competition_analysis_raw.json'), 'r', encoding='utf-8') as f:
    papers = json.load(f)
...
with open(os.path.join(script_dir, 'competition_reviews.json'), 'w', encoding='utf-8') as f:

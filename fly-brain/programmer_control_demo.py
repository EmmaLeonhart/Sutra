...
Demonstrates that S2 is a real programming language, not a found pattern.
...
# --- S2 source code for each program variant ---
...
The only variable was the S2 source code — specifically, the presence or
...
This is what makes S2 a programming language, not a found pattern.
The fly brain is the CPU. The S2 code is the program. Different programs

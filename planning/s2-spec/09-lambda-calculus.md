...
S2's computational universality claim rests on the ability to encode lambda calculus in VSA. This document covers how that encoding works, where it strains, and what it means for S2.

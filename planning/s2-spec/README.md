...
### Runtime & Compilation
- [Runtime Architecture](06-runtime.md) — S1/S2 dual runtime, MCP server as runtime component
...
- [Compute Savings](18-compute-savings.md) — adjacent benchmarks, the missing FLOPS benchmark, what S2 needs to prove

...
9=EQ (push top2==top1 ?1:0), 10=LT (push top2<top1 ?1:0), 11=OUTPUT (pop byte ->
append to the output buffer, like the reference's `output`).
...
verified). CI-guarded: `sdk/sutra-compiler/tests/test_mini_wasm_machine.py` (14/14).

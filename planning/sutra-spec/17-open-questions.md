...
- **Permutation:** Probably not needed for Akasha. Confirm and drop.
...
- **Training pipeline:** How to train a model that produces Akasha-friendly embedding spaces (Phase 1 + Phase 2 from [JEPA Hybrid](12-jepa-hybrid.md))?
- **Benchmark suite:** What tasks should Akasha be benchmarked on to demonstrate practical value?

...
- **Permutation:** Probably not needed for Sutra. Confirm and drop.
...
- **Training pipeline:** How to train a model that produces Sutra-friendly embedding spaces (Phase 1 + Phase 2 from [JEPA Hybrid](12-jepa-hybrid.md))?
- **Benchmark suite:** What tasks should Sutra be benchmarked on to demonstrate practical value?

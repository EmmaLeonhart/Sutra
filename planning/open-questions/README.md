...
- `literals-and-auto-embedding.md` — what is Sutra's literal set, and when does a string literal auto-embed vs. stay a string? Design captured 2026-04-23 (context-driven auto-embed + char literal + fuzzy literal); concrete rules will refine against real programs. Rollout deferred until use cases stress it.

...
| `codegen-v1-feature-coverage.md` | NEARLY CLOSED | Embed/Defuzzy (2026-06-20) + UnsafeCast/UnsafeOverride relabels (2026-07-07/08) + class-body method/operator decls all SHIPPED; open tail = top-level MethodDecl only |
...
- `codegen-v1-feature-coverage.md` — NEARLY CLOSED: Embed/Defuzzy, UnsafeCast (pure relabel, 2026-07-07), UnsafeOverride (passthrough, 2026-07-08), and class-body method/operator decls all lower. Open tail: top-level `MethodDecl` only (refuse-or-support is Emma-shaped).

"""
S2 Bundling Noise & Recovery Experiment
========================================
The REAL noise source in S2 is not chain depth with a single role —
...
def main():
    parser = argparse.ArgumentParser(description='S2 Bundling Noise Experiment')
    parser.add_argument('--model', type=str, default='thenlper/gte-large')
    parser.add_argument('--device', type=str, default='cuda' if torch.cuda.is_available() else 'cpu')
    parser.add_argument('--output', type=str, default=None)
    args = parser.parse_args()

    print(f"S2 Bundling Noise & Recovery Experiment")
    print(f"=======================================")
